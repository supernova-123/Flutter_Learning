    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Container( // 外部是container
          ...
          child: Row( // 内部是row，行自适应
            // mainAxisAlignment: MainAxisAlignment.center, // 居中
            mainAxisAlignment: MainAxisAlignment.spaceAround, // 均匀分布在一行
            // mainAxisAlignment: MainAxisAlignment.end, // 放在最后
            // mainAxisAlignment: MainAxisAlignment.spaceBetween, // 前面和最后的放在两侧
            // mainAxisAlignment: MainAxisAlignment.spaceEvenly, // 和spaceAround看起来差不多
